...
class LanguageManager extends ChangeNotifier {
  ...
  static final Map<AppLanguage, Map<String, String>> _localizedStrings = {
    AppLanguage.chinese: {
      ...
      'image_bed_settings_desc': '配置默认上传服务与路径',
      'image_bed_choose_server': '选择 S3 服务',
      'image_bed_choose_server_hint': '请选择一个已配置的 S3 服务',
      'image_bed_upload_dir': '默认上传目录',
      'image_bed_upload_dir_hint': '例如：images/2026',
    ...
    AppLanguage.english: {
      ...
      'image_bed_upload_dir': 'Default Upload Directory',
      'image_bed_upload_dir_hint': 'e.g. images/2026',
      ...
      'ssh_invalid_key_file': 'Invalid key file, please select a valid PEM private key',
